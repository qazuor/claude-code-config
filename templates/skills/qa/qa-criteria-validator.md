...
config_required:
  - COVERAGE_TARGET: "Minimum test coverage (e.g., 90%)"
  - LCP_TARGET: "Largest Contentful Paint target (e.g., 2.5s)"
  - BUNDLE_TARGET: "Maximum bundle size (e.g., 300KB)"
  - A11Y_STANDARD: "Accessibility standard (e.g., WCAG AA)"
---
