...
Validate implementation against acceptance criteria from PDR.md, ensuring functionality, UI/UX compliance, accessibility (WCAG AA), performance benchmarks, security requirements, and overall quality standards are met before feature completion.
...
- [ ] User can search entitys by city
...
const functionalValidation = {
  ...
  criteriaChecks: [
    {
      criterion: 'User can search entitys by city',
    ...
    },
    {
      ...
      issues: ['Missing fallback image for entitys without photos'],
    },
  ],
};
```text
...
npx pa11y http://localhost:4321/entitys
```text
...
pnpm lighthouse http://localhost:4321/entitys
...
2. Add image fallback for entitys
