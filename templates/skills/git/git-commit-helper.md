...
```bash
git commit -m "perf(search): optimize entity query
...
- Add relationships to entitys and users
...
- Filter entitys by selected city
...
apps/api/src/routes/entitys/search.ts
```text

**Analysis:**
All changes related to adding featured entitys functionality.
...
git commit -m "feat(entitys): add featured entity support

- Add featured_until column to entity schema
- Update EntityModel with featured methods
- Add featured filter to EntityService.search()
- Create API endpoint GET /entitys/featured
...
git commit -m "feat(db): add featured entity schema
...
git commit -m "feat(services): implement featured entity logic
...
git add apps/api/src/routes/entitys/
git commit -m "feat(api): add featured entitys endpoint

- Create GET /entitys/featured route
...
- Add foreign keys to entitys and users
- Create indexes for common queries
...
- Add amenity filtering to EntityService.search()
- Query entitys with matching amenities
...
```bash
git add docs/api/
git commit -m "docs(api): document entity endpoints
