...
C4Context
    ...
    Person(guest, "Guest", "User looking for services")
    Person(owner, "Owner", "Service provider")
    System(platform, "Platform", "Booking platform")
    ...
    Rel(platform, clerk, "Authenticates users", "API")
    Rel(platform, mercadopago, "Processes payments", "API")
