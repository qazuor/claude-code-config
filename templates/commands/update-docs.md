...
config_required:
  - doc_locations: "Define documentation directory paths"
  - doc_types: "Specify documentation categories to maintain"
  - validation_rules: "Configure documentation validation standards"
---
