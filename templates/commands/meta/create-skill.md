...
Guides you through creating a new skill for the project. Skills are specialized, reusable workflows that can be invoked by agents during task execution. This wizard ensures skills follow project standards, integrate properly with agents, and provide clear, actionable workflows.
