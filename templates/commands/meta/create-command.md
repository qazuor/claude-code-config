...
Guides you through creating a new slash command for the project. This interactive wizard ensures commands follow project standards, integrate properly with the workflow, and include comprehensive documentation with clear usage examples.
