...
Structured workflow for adding a new domain entity following the established architecture patterns. Ensures consistent implementation across all layers (Database → Service → API → Frontend).
...
- `/api/parents/{parentId}/{entity}s` - Parent-scoped
